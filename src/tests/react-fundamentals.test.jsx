...
describe('Exercise 3: Event Handling and Synthetic Events', () => {
  ...
  describe('EventDemo', () => {
    it('should handle click events and display event info', async () => {
      ...
      const clickTarget = screen.getByTestId('click-target') || screen.getByText(/click me/i)
    ...
    it('should handle mouse events', async () => {
      ...
      const mouseTarget = screen.getByTestId('mouse-target') || screen.getByText(/hover/i)
    ...
    it('should handle keyboard events', async () => {
      ...
      const keyTarget = screen.getByTestId('key-target') || screen.getByRole('textbox')
...
describe('Exercise 4: Conditional Rendering Patterns', () => {
  ...
  describe('LoadingState', () => {
    ...
    it('should show error message when error exists', () => {
      render(<LoadingState loading={false} error="Something went wrong" data={null} />)
    ...
    it('should prioritize error over data', () => {
      render(<LoadingState loading={false} error="Error occurred" data={['item1']} />)
  ...
  describe('Notification', () => {
    ...
    it('should call onDismiss when dismiss button clicked', async () => {
      ...
      render(<Notification type="info" message="Test" dismissible={true} onDismiss={handleDismiss} />)
...
describe('Exercise 5: Lists and Keys', () => {
  ...
  describe('ShoppingCart', () => {
    it('should render initial empty state', () => {
      render(<ShoppingCart />)
      expect(screen.getByText(/empty/i) || screen.getByText('0')).toBeInTheDocument()
    })
  ...
  describe('CategoryList', () => {
    ...
    it('should be collapsible', async () => {
      ...
      const fruitsToggle = screen.getByText('Fruits').closest('button') || 
...
describe('Exercise 6: Component Composition Patterns', () => {
  describe('Card', () => {
    ...
    it('should have proper structure', () => {
      ...
      expect(content.closest('.card-body') || content.parentElement).toBeTruthy()
    })
  })
...
describe('Exercise 7: Controlled vs Uncontrolled Components', () => {
  describe('ControlledInput', () => {
    ...
    it('should show validation errors', () => {
      ...
      render(<ControlledInput value="" onChange={() => {}} validation={validation} />)
      
      expect(screen.getByText('Required field')).toBeInTheDocument()
    })

    it('should handle different input types', () => {
      render(<ControlledInput value="test@email.com" onChange={() => {}} type="email" />)
    ...
    it('should not show error when validation passes', () => {
      ...
      render(<ControlledInput value="valid" onChange={() => {}} validation={validation} />)
  ...
  describe('HybridForm', () => {
    ...
    it('should handle form submission', async () => {
      ...
      const form = screen.getByRole('form') || screen.getByTestId('hybrid-form')
      const inputs = screen.getAllByRole('textbox')
